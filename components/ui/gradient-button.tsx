...
type ColorVariant = 'teal' | 'emerald' | 'purple' | 'orange'
...
const gradientColors: Record<ColorVariant, GradientColors> = {
  teal: {
    dark: {
      border: 'from-[#3d7770] via-[#1a3834] to-[#28524d]',
      overlay: 'from-[#3d7770]/40 via-[#1a3834] to-[#28524d]/30',
      accent: 'from-[#6fb3ab]/10 via-[#1a3834] to-[#28524d]/50',
      text: 'from-[#9ed4ce] to-[#6fb3ab]',
      glow: 'rgba(111,179,171,0.1)',
      textGlow: 'rgba(111,179,171,0.4)',
      hover: 'from-[#28524d]/20 via-[#6fb3ab]/10 to-[#28524d]/20',
    },
    light: {
      border: 'from-[#3d7770] via-[#569b93] to-[#80b8b1]',
      base: 'from-[#f0f7f6] via-[#f0f7f6]/80 to-[#e4f0ee]/90',
      overlay: 'from-[#80b8b1]/30 via-[#569b93]/20 to-[#3d7770]/20',
      accent: 'from-[#3d7770]/20 via-[#569b93]/10 to-[#80b8b1]/30',
      text: 'from-[#28524d] to-[#3d7770]',
      glow: 'rgba(61,119,112,0.2)',
      hover: 'from-[#80b8b1]/30 via-[#569b93]/20 to-[#80b8b1]/30',
    },
  },
  emerald: {
    dark: {
...
export function GradientButton({
  ...
  const colors = gradientColors[variant] ?? gradientColors.teal
